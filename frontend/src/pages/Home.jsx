                    ...
                    <div style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center" }}>
                      <div style={{ display: "flex", justifyContent: "center", width: "100%", marginBottom: "8px" }}>
                        <span style={{ 
                          ...
                          padding: "2px 8px", 
                          borderRadius: "10px", 
                          color: isFeriado ? "#fff" : "var(--azul-escuro)", 
                          backgroundColor: isFeriado ? "var(--vermelho-erro)" : (item.tipoPost === "projeto" ? "var(--azul-principal)" : "var(--azul-secundario)")
                        }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "15px 20px", borderBottom: "1px solid #f0f0f0" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                      <div style={{ 
                        ...
                        height: "38px", 
                        borderRadius: "50%", 
                        background: "linear-gradient(45deg, var(--azul-principal), var(--azul-secundario))", 
                      ...
                      <div style={{ textAlign: "left" }}>
                        <strong style={{ fontSize: "0.9rem", color: "var(--preto-texto)", display: "block" }}>Informativo escolar</strong>
